...
class Fire : public Meter {
public:
    static const double MAX_TEMP;

    /**
     * @brief Fire Sets the intial properties of a Fire Object
     * @param temperature The Fire object's temperature
     * @param windSpeed The Fire object's wind speed
     * @param windDirection The Fire object's wind direction
     */
    Fire(double temperature, double windSpeed, Direction windDirection);
    ...
    */
    ...
    Return
        type    string      The type of the object as a string.
    */
    virtual double spread(Direction d) override;
    /*
